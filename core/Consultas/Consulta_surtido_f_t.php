...
<html>
<head>
	<title>Surtido Desactivado Fuera de Tiempo</title>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		{
			$.post("controller_consulta.php",{action:"buscar_Bcm",par:par,par2:par2}, function(res)
			{
...
<body>
	<section class="container" id="HTMLtoPDF">
		<div class="card-panel z-depth-3 grey lighten-2">
			...
			<h4 class="center">Surtido desactivado Fuera de  Tiempo</h4>
