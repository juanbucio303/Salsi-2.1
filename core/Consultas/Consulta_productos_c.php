...
<script type="text/javascript">
	$(document).ready(function(){
		...
		{
			$.post("controller_consulta.php",{action:"buscar_Bcc",par:par,par2:par2}, function(res)
			{
...
<body>
	<section class="container" id="HTMLtoPDF">
		<div class="card-panel z-depth-3 grey lighten-2">
			...
			<h4 class="center">Productos Cancelados</h4>
			<div class="container row">
				...
				<table class="table responsive-table bordered ">
					<tr>
						...
						<th>Numero de Cuenta en el Sistema</th>
