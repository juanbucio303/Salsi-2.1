      ...
      <div class="modal-content"> 
      	...
      	<div class="modal-body">
        	<form action="#!" method="post" id="form_alimentos_u">
        				...
        				<input type="hidden" value="update_b" id="action" name="action" type="hidden">
...
$("#modal_a_u").modal('open');
  ...
  if(isset($_GET["id_producto"]))
    {
      ?>
        $.post("core/Alimentos/controller_alimentos.php",{action:"get_one_b",id_producto:<?php echo $_GET["id_producto"]?>},function(res){
