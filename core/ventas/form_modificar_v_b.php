<div class="modal" id="form_modificar_cv" style="width: 80%; height: 80%;">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="#!" method="post" id="form_modificar_v">

							<input type="hidden" value="modificar_venb" id="action" name="action">
...
<script type="text/javascript">
	...
	$("#form_modificar_cv").modal();
	$("#form_modificar_cv").modal('open');
	$("#VENDER").click(function(){
		$("#form_modificar_v").submit();
	...
	$("#form_modificar_v").validate({
		...
		submitHandler:function(form){
			...
			$("#btn_confirm_modificar").click(function(event){
				...
				$.post("core/ventas/controller_ventas.php",$("#form_modificar_v").serialize()
				,function(res){
